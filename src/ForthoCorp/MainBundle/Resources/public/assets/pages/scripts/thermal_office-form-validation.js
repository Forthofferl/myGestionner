        ...
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                rules: {
                    ...
                    'thermal_office_form_type[description]': {
                        required: false
                    },
                    'thermal_office_form_type[url]': {
                        required: false,
                        url: true
                    },
                    'thermal_office_form_type[siret]': {
                        required: false
                    },
                    'thermal_office_form_type[tva]': {
                        required: false
                    },
                    ...
                    'thermal_office_form_type[mobile]': {
                        required: false
                    },
                    'thermal_office_form_type[fax]': {
                        required: false
                    },
